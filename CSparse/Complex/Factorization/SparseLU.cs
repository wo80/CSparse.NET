...
namespace CSparse.Complex.Factorization
{
    ...
    public class SparseLU : ISparseFactorization<Complex>
    {
        ...
        public SparseLU(CompressedColumnStorage<Complex> A, ColumnOrdering order, double tol)
        {
        ...
        /// </summary>
        private void Factorize(CompressedColumnStorage<Complex> A, double tol)
        {
            int[] q = S.q;
        ...
        /// <param name="A"></param>
        private void SymbolicAnalysis(ColumnOrdering order, CompressedColumnStorage<Complex> A)
        {
